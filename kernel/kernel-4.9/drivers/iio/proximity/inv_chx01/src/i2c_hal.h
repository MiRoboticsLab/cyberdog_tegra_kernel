...
unsigned long i2c_master_write_raw(unsigned char Address,
	unsigned short len, unsigned char *data); //--yd	
	unsigned long i2c_master_read_raw(unsigned char Address,
	unsigned short len, unsigned char *data); //--yd
unsigned long i2c_master_read_register_client(void *ch_client, unsigned char Address,
	unsigned char RegAddr, unsigned short RegLen, unsigned char *RegValue); //--yd
unsigned long i2c_master_write_register_client(void *ch_client, unsigned char Address,
	unsigned char RegAddr, unsigned short RegLen, unsigned char *RegValue); //--yd
