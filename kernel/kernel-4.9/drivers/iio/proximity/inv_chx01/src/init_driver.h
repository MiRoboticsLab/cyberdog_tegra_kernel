...
#define IQ_DATA_MAX_NUM_SAMPLES  CHx01_MAX_NUM_SAMPLES	// use CH201 I/Q size

/* Bit flags used in main loop to check for completion of sensor I/O.  */
#define DATA_READY_FLAG			(1 << 0)
#define IQ_READY_FLAG			(1 << 1)

#define MAX_RX_SAMPLES			130
#define MAX_NB_SAMPLES			130
...
#define CHIRP_SENSOR_SAMPLE_INTERVAL	100
