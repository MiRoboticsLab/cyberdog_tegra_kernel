				  ...
				  u64 formats)
{
	...
	err = snd_soc_dai_set_tdm_slot(rtd->codec_dai, 0x3f, 0x0, 6, 16);
	if (err < 0) {
...
MODULE_AUTHOR("Mohan Kumar <mkumard@nvidia.com>,Sameer Pujar <spujar@nvidia.com>， Zhongxi Zhao <zhaozhongxi@xiaomi.com>， Jiali Gao <gaojiali@xiaomi.com>");
